...
import { Spinner, ShieldCheck, Sun, Moon } from '@phosphor-icons/react';
...
export default function LoginPage() {
  ...
  return (
    <main className="min-h-screen w-full flex flex-col md:flex-row bg-zinc-50 dark:bg-zinc-950 text-zinc-900 dark:text-zinc-100 transition-colors duration-300 relative font-sans">
      ...
      <div className="hidden md:flex md:w-1/2 min-h-screen relative flex-col justify-between p-12 bg-gradient-to-br from-[#1a0826] via-[#0e0417] to-[#06020a] text-white overflow-hidden select-none">
        ...
        <div className="relative flex flex-col items-center text-center my-auto z-10 w-full">
          ...
          <h2 className="text-3xl font-extrabold tracking-tight text-white mb-3 leading-tight font-sans">
            Invitaciones con <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 via-pink-400 to-amber-300">gran impresión</span>
          </h2>
          <p className="text-xs text-zinc-400 max-w-sm leading-relaxed">
            Diseños interactivos y fluidos para tus eventos más selectos, administrados de manera ágil desde un panel unificado.
          </p>
        </div>
      ...
      {/* RIGHT SIDE: LOGIN FORM (Full screen height, 50% split) */}
        ...
        <div className="w-full max-w-[460px] flex flex-col gap-10">
          ...
          <form onSubmit={handleLogin} className="flex flex-col gap-8">
            ...
            <div className="flex flex-col gap-1 relative">
              ...
              <div className="text-right mt-2 px-6">
                <a href="#" className="text-xs font-semibold text-zinc-400 hover:text-purple-600 dark:hover:text-purple-400 transition-colors">
            ...
            <div className="flex justify-center mt-1">
              <label className="flex items-center gap-2.5 text-sm text-zinc-500 dark:text-zinc-400 cursor-pointer select-none">
                <input 
                  type="checkbox" 
                  className="rounded border-zinc-300 dark:border-zinc-700 text-purple-600 focus:ring-purple-500 bg-white dark:bg-zinc-900 h-4.5 w-4.5" 
                />
                Recordar mi sesión
              </label>
            </div>
          ...
          <div className="text-center text-sm text-zinc-500 dark:text-zinc-400">
            ...
            <Link href="/register" className="font-bold text-purple-600 dark:text-purple-400 hover:text-purple-500 dark:hover:text-purple-300 hover:underline transition">
              Regístrate
            </Link>
          </div>
