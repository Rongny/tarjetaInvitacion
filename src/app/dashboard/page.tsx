...
export default function DashboardPage() {
  ...
  return (
    <div className="min-h-screen w-full flex flex-col items-center bg-zinc-50 dark:bg-[#09090b] text-zinc-900 dark:text-zinc-100 pb-20 font-sans transition-colors duration-300">
      
      {/* Top Navbar */}
      <header className="sticky top-0 z-50 w-full border-b border-zinc-200 dark:border-white/5 bg-white/80 dark:bg-zinc-950/80 backdrop-blur-md transition-colors duration-300">
        <div className="mx-auto max-w-[1440px] px-6 sm:px-10 lg:px-16">
          <div className="flex h-20 items-center justify-between">
            <div className="flex items-center gap-4">
              <div className="flex h-11 w-11 items-center justify-center rounded-xl bg-purple-600/10 border border-purple-500/30 text-purple-600 dark:text-purple-400">
                <Globe size={24} weight="duotone" />
              </div>
              <div>
                <span className="font-extrabold tracking-tight text-zinc-950 dark:text-white text-xl">Lacre</span>
                <span className="text-[10px] ml-2 px-2.5 py-0.5 rounded-full bg-purple-500/10 text-purple-600 dark:text-purple-400 border border-purple-500/20 font-bold uppercase tracking-wider">SaaS</span>
              </div>
            </div>

            <div className="flex items-center gap-4 sm:gap-6">
              <div className="text-right hidden sm:block">
                <p className="text-sm font-bold text-zinc-700 dark:text-zinc-300">{clientProfile?.business_name}</p>
                <p className="text-xs text-zinc-400 dark:text-zinc-500 font-mono mt-0.5">{clientProfile?.email}</p>
              </div>
              ...
              <button
                ...
                disabled={refreshing}
                className="p-2.5 rounded-xl bg-zinc-100 dark:bg-zinc-900 border border-zinc-200 dark:border-white/5 hover:bg-zinc-200 dark:hover:bg-zinc-800 text-zinc-500 dark:text-zinc-400 transition cursor-pointer disabled:opacity-50 flex items-center justify-center"
                aria-label="Actualizar datos"
                title="Actualizar confirmaciones"
              >
                <ArrowsClockwise size={18} className={`${refreshing ? 'animate-spin text-purple-600 dark:text-purple-400' : ''}`} />
              </button>

              {/* Theme Toggle Button */}
              <button
                onClick={toggleTheme}
                className="p-2.5 rounded-xl bg-zinc-100 dark:bg-zinc-900 border border-zinc-200 dark:border-white/5 hover:bg-zinc-200 dark:hover:bg-zinc-800 text-zinc-500 dark:text-zinc-400 transition cursor-pointer"
              ...
              <button
                ...
                className="flex items-center gap-2 rounded-xl bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-white/5 px-4.5 py-2.5 text-sm font-bold hover:bg-zinc-100 dark:hover:bg-zinc-800 text-zinc-700 dark:text-zinc-300 transition duration-150 cursor-pointer shadow-sm"
              >
                <SignOut size={18} />
      ...
      {/* Main Grid Content */}
      <main className="w-full max-w-[1440px] px-6 sm:px-10 lg:px-16 mt-12">
            ...
            <div className="h-full rounded-[calc(2.5rem-0.5rem)] bg-zinc-100/10 dark:bg-zinc-900/40 p-6 sm:p-8 ring-1 ring-black/5 dark:ring-black/40 flex flex-col justify-between">
              ...
              {!editingEvent ? (
                  ...
                  <div>
                    <div className="flex items-center justify-between mb-5 border-b border-zinc-200/50 dark:border-white/5 pb-4">
                      ...
                      <button
                        ...
                        className="rounded-xl bg-zinc-100 dark:bg-zinc-900 border border-zinc-200 dark:border-white/5 hover:border-purple-500/40 dark:hover:border-purple-500/40 hover:bg-zinc-200 dark:hover:bg-zinc-800 text-xs px-5 py-2.5 font-bold uppercase tracking-wider text-purple-600 dark:text-purple-400 transition cursor-pointer shadow-sm"
                      >
                        Configurar
                      </button>
                    </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-5 gap-x-6">
                      <div className="flex items-start gap-4">
                        ...
                        <div>
                          <span className="text-[11px] lg:text-xs font-bold uppercase tracking-wider text-zinc-400 dark:text-zinc-500 block mb-1">Anfitriona</span>
                          <span className="text-base text-zinc-800 dark:text-zinc-200 font-bold">{event?.host_name}</span>
                        </div>
                      </div>

                      <div className="flex items-start gap-4">
                        <div className="text-zinc-400 dark:text-zinc-500 mt-1"><Calendar size={20} /></div>
                        <div>
                          <span className="text-[11px] lg:text-xs font-bold uppercase tracking-wider text-zinc-400 dark:text-zinc-500 block mb-1">Fecha del Evento</span>
                          <span className="text-base text-zinc-800 dark:text-zinc-200 font-bold font-mono">
                      ...
                      <div className="flex items-start gap-4 sm:col-span-2">
                        <div className="text-zinc-400 dark:text-zinc-500 mt-1"><MapPin size={20} /></div>
                        <div>
                          <span className="text-[11px] lg:text-xs font-bold uppercase tracking-wider text-zinc-400 dark:text-zinc-500 block mb-1">Lugar & Dirección</span>
                          <span className="text-base text-zinc-800 dark:text-zinc-200 font-bold block">{event?.location_name}</span>
                          <span className="text-sm text-zinc-500 dark:text-zinc-400 block mt-1">{event?.location_address}</span>
                        </div>
                      </div>

                      <div className="flex items-start gap-4 sm:col-span-2">
                        <div className="text-zinc-400 dark:text-zinc-500 mt-1"><Palette size={20} /></div>
                        <div>
                          <span className="text-[11px] lg:text-xs font-bold uppercase tracking-wider text-zinc-400 dark:text-zinc-500 block mb-2">Colores del Tema (Diseño)</span>
                          <div className="flex flex-wrap gap-3 mt-1">
                            <span className="flex items-center gap-2 text-xs font-semibold text-zinc-600 dark:text-zinc-400 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-white/5 px-3.5 py-2 rounded-xl shadow-sm">
                              <span className="w-3.5 h-3.5 rounded-full border border-zinc-300 dark:border-white/10" style={{ backgroundColor: event?.theme_colors?.primary }} />
                              Principal
                            </span>
                            <span className="flex items-center gap-2 text-xs font-semibold text-zinc-600 dark:text-zinc-400 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-white/5 px-3.5 py-2 rounded-xl shadow-sm">
                              <span className="w-3.5 h-3.5 rounded-full border border-zinc-300 dark:border-white/10" style={{ backgroundColor: event?.theme_colors?.secondary }} />
                              Secundario
                            </span>
                            <span className="flex items-center gap-2 text-xs font-semibold text-zinc-600 dark:text-zinc-400 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-white/5 px-3.5 py-2 rounded-xl shadow-sm">
                              <span className="w-3.5 h-3.5 rounded-full border border-zinc-300 dark:border-white/10" style={{ backgroundColor: event?.theme_colors?.accent }} />
                              Acento
                            </span>
                            <span className="flex items-center gap-2 text-xs font-semibold text-zinc-600 dark:text-zinc-400 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-white/5 px-3.5 py-2 rounded-xl shadow-sm">
                              <span className="w-3.5 h-3.5 rounded-full border border-zinc-300 dark:border-white/10" style={{ backgroundColor: event?.theme_colors?.gold }} />
                              Oro
                            </span>
                          </div>
                        </div>
                ...
                <form onSubmit={handleUpdateEvent} className="space-y-6">
                  <div className="flex items-center justify-between mb-4 border-b border-zinc-200/50 dark:border-white/5 pb-4">
                    ...
                    <div className="flex gap-3.5">
                      <button
                        ...
                        className="rounded-xl bg-zinc-100 dark:bg-zinc-900 border border-zinc-200 dark:border-white/5 text-xs px-4.5 py-2.5 font-bold uppercase tracking-wider text-zinc-500 dark:text-zinc-400 hover:bg-zinc-200 dark:hover:bg-zinc-800 transition cursor-pointer shadow-sm"
                      >
                        Cancelar
                      </button>
                      <button
                        ...
                        className="rounded-xl bg-purple-600 text-xs px-4.5 py-2.5 font-bold uppercase tracking-wider text-white hover:bg-purple-500 transition flex items-center gap-1.5 cursor-pointer disabled:opacity-50 shadow-sm shadow-purple-500/20"
                      >
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    <div>
                      <label className="block text-xs font-bold uppercase tracking-wider text-zinc-500 dark:text-zinc-400 mb-2">Nombre del Anfitrión/a</label>
                      <input
                        type="text"
                        required
                        value={editHostName}
                        onChange={(e) => setEditHostName(e.target.value)}
                        className="w-full text-sm h-[48px] rounded-xl border-0 bg-white dark:bg-zinc-900 py-0 px-4 text-zinc-950 dark:text-white ring-1 ring-zinc-200 dark:ring-white/10 focus:ring-2 focus:ring-purple-500 focus:outline-none shadow-sm"
                      />
                    </div>
                    <div>
                      <label className="block text-xs font-bold uppercase tracking-wider text-zinc-500 dark:text-zinc-400 mb-2">Fecha y Hora</label>
                      <input
                        type="datetime-local"
                        required
                        value={editEventDate}
                    ...
                    <div>
                      <label className="block text-xs font-bold uppercase tracking-wider text-zinc-500 dark:text-zinc-400 mb-2">Lugar (Nombre)</label>
                      <input
                        type="text"
                        required
                    ...
                    <div>
                      <label className="block text-xs font-bold uppercase tracking-wider text-zinc-500 dark:text-zinc-400 mb-2">Mapa (Google Maps URL)</label>
                      <input
                        type="url"
                    ...
                    <div className="sm:col-span-2">
                      <label className="block text-xs font-bold uppercase tracking-wider text-zinc-500 dark:text-zinc-400 mb-2">Dirección Completa</label>
                      <input
                        type="text"
                        required
                    ...
                    <div>
                      <label className="block text-xs font-bold uppercase tracking-wider text-zinc-500 dark:text-zinc-400 mb-2">Música (URL MP3)</label>
                      <input
                        type="url"
                    ...
                    <div>
                      <label className="block text-xs font-bold uppercase tracking-wider text-zinc-500 dark:text-zinc-400 mb-2">Carpeta de Fotos (Galería)</label>
                      <input
                        type="url"
                  ...
                  <div className="pt-4 border-t border-zinc-200 dark:border-white/5">
                    <label className="block text-xs font-bold uppercase tracking-wider text-zinc-500 dark:text-zinc-400 mb-3.5">Paleta de Colores (Hex)</label>
                    <div className="grid grid-cols-4 gap-4">
                      <div>
                        <span className="text-[10px] text-zinc-400 dark:text-zinc-500 font-semibold block mb-1.5">Principal</span>
                        <div className="flex gap-2">
                          <input type="color" value={editColorPrimary} onChange={(e) => setEditColorPrimary(e.target.value)} className="w-8 h-8 border-0 bg-transparent rounded cursor-pointer" />
                          <input type="text" value={editColorPrimary} onChange={(e) => setEditColorPrimary(e.target.value)} className="w-full text-xs h-[32px] bg-white dark:bg-zinc-900 text-zinc-950 dark:text-white rounded-lg px-2 border border-zinc-200 dark:border-white/5 font-mono shadow-sm" />
                        </div>
                      </div>
                      <div>
                        <span className="text-[10px] text-zinc-400 dark:text-zinc-500 font-semibold block mb-1.5">Secundario</span>
                        <div className="flex gap-2">
                          <input type="color" value={editColorSecondary} onChange={(e) => setEditColorSecondary(e.target.value)} className="w-8 h-8 border-0 bg-transparent rounded cursor-pointer" />
                          <input type="text" value={editColorSecondary} onChange={(e) => setEditColorSecondary(e.target.value)} className="w-full text-xs h-[32px] bg-white dark:bg-zinc-900 text-zinc-950 dark:text-white rounded-lg px-2 border border-zinc-200 dark:border-white/5 font-mono shadow-sm" />
                        </div>
                      </div>
                      <div>
                        <span className="text-[10px] text-zinc-400 dark:text-zinc-500 font-semibold block mb-1.5">Acento</span>
                        <div className="flex gap-2">
                          <input type="color" value={editColorAccent} onChange={(e) => setEditColorAccent(e.target.value)} className="w-8 h-8 border-0 bg-transparent rounded cursor-pointer" />
                          <input type="text" value={editColorAccent} onChange={(e) => setEditColorAccent(e.target.value)} className="w-full text-xs h-[32px] bg-white dark:bg-zinc-900 text-zinc-950 dark:text-white rounded-lg px-2 border border-zinc-200 dark:border-white/5 font-mono shadow-sm" />
                        </div>
                      </div>
                      <div>
                        <span className="text-[10px] text-zinc-400 dark:text-zinc-500 font-semibold block mb-1.5">Oro</span>
                        <div className="flex gap-2">
                          <input type="color" value={editColorGold} onChange={(e) => setEditColorGold(e.target.value)} className="w-8 h-8 border-0 bg-transparent rounded cursor-pointer" />
                          <input type="text" value={editColorGold} onChange={(e) => setEditColorGold(e.target.value)} className="w-full text-xs h-[32px] bg-white dark:bg-zinc-900 text-zinc-950 dark:text-white rounded-lg px-2 border border-zinc-200 dark:border-white/5 font-mono shadow-sm" />
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div className="flex flex-col xl:flex-row xl:items-center xl:justify-between gap-6 mb-8 border-b border-zinc-200/50 dark:border-white/5 pb-6">
                ...
                <div className="flex flex-wrap items-center gap-3 sm:self-stretch xl:self-auto">
                  ...
                  <div className="flex rounded-xl bg-white dark:bg-zinc-900 p-2.5 ring-1 ring-zinc-200 dark:ring-white/10 w-full sm:w-auto shadow-sm">
                    {(['all', 'pending', 'confirmed', 'declined'] as const).map((st) => (
                      <button
                        ...
                        className={`text-xs font-bold uppercase tracking-wider px-4.5 py-2.5 rounded-lg transition cursor-pointer flex-1 text-center min-w-[70px] ${
                          statusFilter === st 
                  ...
                  <button
                    ...
                    className="flex h-[48px] items-center justify-center gap-2 rounded-xl bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-white/5 hover:bg-zinc-100 dark:hover:bg-zinc-800 text-sm font-bold uppercase tracking-wider px-6 text-zinc-700 dark:text-zinc-300 hover:text-zinc-950 dark:hover:text-white shadow-sm transition cursor-pointer w-full sm:w-auto"
                  >
                    <CopySimple size={18} />
                    Copiar Enlaces
                  </button>
              ...
              <form onSubmit={handleAddGuest} className="grid grid-cols-1 sm:grid-cols-12 gap-5 bg-zinc-100/50 dark:bg-zinc-950/40 rounded-2xl p-6 border border-zinc-200 dark:border-white/5 mb-8">
                <div className="sm:col-span-4">
                  <input
                    ...
                    className="w-full text-sm h-[48px] rounded-xl border-0 bg-white dark:bg-zinc-900 py-0 px-4 text-zinc-950 dark:text-white ring-1 ring-zinc-200 dark:ring-white/5 focus:ring-2 focus:ring-purple-500 focus:outline-none shadow-sm"
                  />
                </div>
                <div className="sm:col-span-2">
                  <div className="relative">
                    <input
                      ...
                      className="w-full text-sm h-[48px] rounded-xl border-0 bg-white dark:bg-zinc-900 py-0 pl-4 pr-12 text-zinc-950 dark:text-white ring-1 ring-zinc-200 dark:ring-white/5 focus:ring-2 focus:ring-purple-500 focus:outline-none font-mono shadow-sm"
                      placeholder="Cupos"
                    />
                    <span className="absolute right-3.5 top-1/2 -translate-y-1/2 text-[10px] font-bold text-zinc-400 dark:text-zinc-500 uppercase">Pases</span>
                  </div>
                </div>
                <div className="sm:col-span-2">
                  <select
                    ...
                    className="w-full text-sm h-[48px] rounded-xl border-0 bg-white dark:bg-zinc-900 py-0 px-4 text-zinc-950 dark:text-white ring-1 ring-zinc-200 dark:ring-white/5 focus:ring-2 focus:ring-purple-500 focus:outline-none cursor-pointer shadow-sm"
                  >
                ...
                <div className="sm:col-span-1">
                  <button
                    ...
                    className="w-full flex h-[48px] items-center justify-center rounded-xl bg-purple-600 hover:bg-purple-500 text-white font-bold transition py-0 cursor-pointer disabled:opacity-50 shadow-sm shadow-purple-500/20"
                  >
              ...
              <div className="space-y-4 max-h-72 overflow-y-auto pr-2">
                {activities.length === 0 ? (
                  ...
                  activities.map((act) => (
                    <div 
                      key={`${act.id}-${act.time}`} 
                      className="flex items-center justify-between text-sm bg-white dark:bg-zinc-900/30 rounded-xl p-4.5 border border-zinc-200 dark:border-white/5 hover:bg-zinc-50 dark:hover:bg-zinc-900/50 shadow-sm dark:shadow-none transition"
                    >
                      <div className="flex items-center gap-3.5">
